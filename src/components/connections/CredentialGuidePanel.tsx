import { BookOpen, CheckCircle2, ExternalLink, KeyRound, ShieldCheck } from 'lucide-react';
      ...
      <div className="space-y-2">
        ...
        <ol className="space-y-1.5">
          {guide.steps.map((step, index) => (
            <li key={step} className="flex gap-2 leading-relaxed text-muted-foreground">

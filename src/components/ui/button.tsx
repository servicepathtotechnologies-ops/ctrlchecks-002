  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 motion-reduce:transition-colors",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent/10 hover:text-foreground hover:-translate-y-0.5 active:translate-y-0 dark:hover:bg-accent/15",
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/85 hover:text-secondary-foreground hover:-translate-y-0.5 hover:shadow-md active:translate-y-0",
        ghost: "hover:bg-accent/10 hover:text-foreground dark:hover:bg-accent/15",

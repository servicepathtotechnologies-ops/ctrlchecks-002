 ...
 * Worker: attach-credentials accepts workflows in `ready_for_ownership` and
 ...
 * Do not use `ready_for_execution`: attach-inputs sets that when no credential step is needed.
 */
